...
<head>
    ...
    <link rel='stylesheet' href="{{URL::asset('assets/newcalendar/css/mobiscroll.javascript.min.css')}}" />
    <script src="{{URL::asset('assets/newcalendar/js/mobiscroll.javascript.min.js')}}"></script>
