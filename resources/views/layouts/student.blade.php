        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-4 d-flex">
                    <div class="image">
                        <img id="imgpreview" src="/uploads/profileimg/{{auth()->user()->profileimg}}" alt="" style="border-radius:100%;width:100%;max-width:33px;max-height:33px;height:100%;box-shadow:2px 2px 5px rgb(0 0 0 / 40%);height:auto;width:1.8rem;">
                    </div>
                    <div class="info">
                        <a href="stdintoprofile" class="d-block">{{auth()->user()->name}}&nbsp;{{auth()->user()->lastname}}</a>
                    </div>
                </div>
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item mt-3">
                            <a href="/stdproject" class="nav-link">
