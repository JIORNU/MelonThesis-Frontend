    ...
    <div class="container">
        <div class="card-container">
            ...
            <div class="melon-area">
                <div class="logo-div">
                    <img src="{{asset('assets/img/logo/rmutt-logo.png')}}" alt="rmutt-logo">
                </div>
                <div class="floating-div">
                    @if ($head[0]->species == "ฮามิกัว")
                    <div class="melon-1"><img src="{{asset('assets/img/melon/hamigua1.jpg')}}" style="border-radius: 30px;box-shadow:2px 2px 5px rgb(0 0 0 / 40%)" alt="melon-1"></div>
                    <div class="melon-2"><img src="{{asset('assets/img/melon/hamigua2.jpg')}}" style="border-radius: 30px;box-shadow:2px 2px 5px rgb(0 0 0 / 40%)" alt="melon-2"></div>
                    @endif
                    @if ($head[0]->species == "ไข่ทองคำ")
                    <div class="melon-1"><img src="{{asset('assets/img/melon/kaitongkum1.jpg')}}" style="border-radius: 30px;box-shadow:2px 2px 5px rgb(0 0 0 / 40%)" alt="melon-1"></div>
                    <div class="melon-2"><img src="{{asset('assets/img/melon/kaitongkum2.jpg')}}" style="border-radius: 30px;box-shadow:2px 2px 5px rgb(0 0 0 / 40%)" alt="melon-2"></div>
                    @endif
                    @if($head[0]->species == "กรีนเน็ต")
                    <div class="melon-1"><img src="{{asset('assets/img/melon/green_net_melon1.jpg')}}" style="border-radius: 30px;box-shadow:2px 2px 5px rgb(0 0 0 / 40%)" alt="melon-1"></div>
                    <div class="melon-2"><img src="{{asset('assets/img/melon/green_net_melon2.jpg')}}" style="border-radius: 30px;box-shadow:2px 2px 5px rgb(0 0 0 / 40%)" alt="melon-2"></div>
                    @endif
                    @if($head[0]->species == "อินทนนท์")
                    <div class="melon-1"><img src="{{asset('assets/img/melon/inthanon1.jpg')}}" style="border-radius: 30px;box-shadow:2px 2px 5px rgb(0 0 0 / 40%)" alt="melon-1"></div>
                    <div class="melon-2"><img src="{{asset('assets/img/melon/inthanon2.jpg')}}" style="border-radius: 30px;box-shadow:2px 2px 5px rgb(0 0 0 / 40%)" alt="melon-2"></div>
                    @endif
                </div>
            </div>
            <div class="text-area">
                <div class="heading-area">
                    <h2>{{$head[0]->species}}</h2>
                ...
                <div class="paragraph-area">
                    ...
                    <div class="show-id-detail">
                        <p>แปลง : {{$head[0]->projectname}}</p>
                    </div>
                    <div class="show-startdate-detail">
                        <p>เริ่มปลูกวันที่ : {{$head[0]->dateproject}}</p>
                    </div>
                    <div class="show-width-detail">
                        <p>ความกว้างผล : {{$qr[0]->widthofyield}} เซนติเมตร.</p>
                    </div>
                    <div class="show-sweet-detail">
                        <p>ค่าความหวาน : {{$qr[0]->Brix}} บริกซ์</p>
                    </div>
                    <div class="show-sweet-detail">
                        <p>น้ำหนักผล : {{$qr[0]->weight}} กิโลกรัม</p>
                    </div>
                    <div class="show-enddate-detail">
                        <p>เก็บเกี่ยววันที่ : {{$splitdate[0]}}</p>
                    </div>
