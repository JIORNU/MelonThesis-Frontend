            ...
            <div class="text-area">
                ...
                <div class="paragraph-area">
                    ...
                    <div class="show-startdate-detail">
                        <p>เริ่มปลูกวันที่ : 05/05/2564</p>
                    </div>
                    <div class="show-width-detail">
                        <p>ความกว้างผล : 12 เซนติเมตร.</p>
                    </div>
                    <div class="show-sweet-detail">
                        <p>ค่าความหวาน : 5 ml</p>
                    </div>
                    <div class="show-sweet-detail">
                        <p>น้ำหนักผล : 5 กิโลกรัม</p>
                    </div>
                    <div class="show-enddate-detail">
                        <p>เก็บเกี่ยววันที่ : 011/011/2564</p>
                    </div>
                    <div class="show-location-detail">
                        <h6>สถานที่ปลูก : <br>
                            มหาวิทยาลัยเทคโนโลยีราชมงคล-รังสิต คณะเทคโนโลยีการเกษตร สาขา การผลิตพืช</h6>
                    </div>
                </div>
