        ...
        <div class="card mt-5 p-5">
            <div class="row">
                ...
                <div class="col-4 d-flex justify-content-center">
                    <h5>พันเธุ์เมลอน : {{$project[0]->species}}</h5>
                </div>
                ...
                <div class="modal fade" id="stdaddproject" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form class="formmodal" method="POST" action="{{ route('addinfo') }}">
                                @csrf
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <input name="projectid" type="text" value="{{$id}}" style="display: none;">
                                    </div>
                                </div>
            ...
            <div class="row">
                ...
                <div class="col-4 d-flex justify-content-end">
                    <form method="post" action="{{route('successproject')}}" enctype="multipart/form-data">
                        @csrf
