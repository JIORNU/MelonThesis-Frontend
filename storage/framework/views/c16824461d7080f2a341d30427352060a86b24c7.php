        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-4">
                            <p class="text-end">วันลงบันทึก:</p>
                        </div>
                        <div class="col-8">
                            <input type="date" class="ms-2 text-center" style="height: 25px; width:250px; border-radius:5px;">
                        </div>
                        <div class="col-4 text-right">
                            <p class="text-end">เวลา:</p>
                        </div>
                        <div class="col-8">
                            <input type="time" class="ms-2 text-center" style="height: 25px; width:250px; border-radius:5px;">
                        </div>
                        <div class="col-4">
                            <p class="text-end">ความสูงต้น:</p>
                        </div>
                        <div class="col-8">
                            <input type="text" class="ms-2 text-center" style="height: 25px; width:250px; border-radius:5px;">
                        </div>
                        <div class="col-4">
                            <p class="text-end">ความกว้างใบ:</p>
                        </div>
                        <div class="col-8">
                            <input type="text" class="ms-2 text-center" style="height: 25px; width:250px; border-radius:5px;">
                        </div>
                        <div class="col-4">
                            <p class="text-end">จำนวนใบ:</p>
                        </div>
                        <div class="col-8">
                            <input type="text" class="ms-2 text-center" style="height: 25px; width:250px; border-radius:5px;">
                        </div>
                        <div class="col-4 text-right" style="padding-left:0px;">
                            <p>เส้นผ่าศูนย์กลางลำต้น:</p>
                        </div>
                        <div class="col-8">
                            <input type="text" class="ms-2 text-center" style="height: 25px; width:250px; border-radius:5px;">
                        </div>
                        <div class="col-4">
                            <p class="text-end">ปริมาณคลอโรฟิลล์:</p>
                        </div>
                        <div class="col-8">
                            <input type="text" class="ms-2 text-center" style="height: 25px; width:250px; border-radius:5px;">
                        </div>
                        <div class="col-4">
                            <p class="text-end">ความกว้างผล:</p>
                        </div>
                        <div class="col-8">
                            <input type="text" class="ms-2 text-center" style="height: 25px; width:250px; border-radius:5px;">
                        </div>
                        <div class="col-4">
                            <p class="text-end">ค่าความหวาน:</p>
                        </div>
                        <div class="col-8">
                            <input type="text" class="ms-2 text-center" style="height: 25px; width:250px; border-radius:5px;">
                        </div>
                        <div class="col-4">
                            <p class="text-end">น้ำหนัก:</p>
                        </div>
                        <div class="col-8">
                            <input type="text" class="ms-2 text-center" style="height: 25px; width:250px; border-radius:5px;">
                        </div>
                        <div class="col-4">
                            <p class="text-end">หมายเหตุ:</p>
                        </div>
                        <div class="col-8">
                            <input type="text" class="ms-2 text-center" style="height: 25px; width:250px; border-radius:5px;">
                        </div>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/MelonNew/resources/views/admin/admin_add_melon_info.blade.php ENDPATH**/ ?>