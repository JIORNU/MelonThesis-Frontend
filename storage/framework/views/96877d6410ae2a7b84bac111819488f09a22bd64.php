            ...
            <div class="card-body">
                    ...
                    <div class="modal fade" id="addprojectModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                ...
                                <form id="formaddproject" method="POST" action="<?php echo e(route('intoproject')); ?>">
                                    <?php echo csrf_field(); ?>
                ...
                <div class="d-flex justify-content-center mb-2">
                    <div class="card mt-4" style="width: 1000px;z-index:1">
                        <table id="table_select" data-toggle="table" data-height="400" data-side-pagination="server" data-pagination="true" data-page-size="All" data-query-params="searchQueryParams_invsetment" data-url="<?php echo e(route('teacherqueryprojects')); ?>" data-method="get">
                            <thead>
                                <tr class="tr_style">
    ...
    <div class="d-flex justify-content-center ">
        <div class="card mt-5 mb-5">
            <div class="card-body">
                    ...
                    <div class="modal fade" id="addprojectModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                ...
                                <form method="POST" action="<?php echo e(route('intoproject')); ?>">
                                    <?php echo csrf_field(); ?>
                                    <div class="modal-body text-center">
                ...
                <div class="d-flex justify-content-center mb-2">
                    <div class="card mt-4" style="width: 1000px;z-index:1">
                        <table id="table_select" data-toggle="table" data-height="400" data-side-pagination="server" data-pagination="true" data-page-size="All" data-query-params="searchQueryParams_invsetment" data-url="<?php echo e(route('teacherqueryprojectssuccess')); ?>" data-method="get">
                            <thead>
                                <tr class="tr_style">
                                    <th data-field="id" class="th-2 font-table-modal "><label class="modal-header-f justify-content-center d-flex">รายการ</th>
                                    <th data-field="projectname" class="th-2 font-table-modal"><label class="modal-header-f justify-content-center d-flex">ชื่อกิจกรรม</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="formmodal" method="POST" action="<?php echo e('editprojects'); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="row d-flex justify-content-center">
                            <div class="col-6">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form method="POST" action="<?php echo e(route('downloadqr')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.teacher', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/MelonNew/resources/views/teacher/addproject.blade.php ENDPATH**/ ?>