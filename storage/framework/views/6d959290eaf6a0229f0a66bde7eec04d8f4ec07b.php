    ...
    <div class="container-fluid">
        <div class="row d-flex justify-content-center">
            <div class="card cardedit " style="width:700px; height: 612px;border-radius:12px;box-shadow:2px 2px 5px rgb(0 0 0 / 40%);">
                ...
                <div class="card-body">
                    <form id="editprofile" action="<?php echo e(route('editstdintoprofile')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-12">
...
<?php echo $__env->make('layouts.student', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/MelonNew/resources/views/student/stdintoprofile.blade.php ENDPATH**/ ?>