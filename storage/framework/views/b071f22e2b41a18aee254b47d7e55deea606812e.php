        ...
        <div class="card mt-5 p-5">
            <div class="row">
                ...
                <div class="col-4 d-flex justify-content-end">
                    <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#stdaddproject" style="font-size:1rem;">บันทึกข้อมูลเมล่อน</button>
                </div>

                <div class="modal fade" id="stdaddproject" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header d-flex justify-content-center">
                                <h5 class="modal-title" id="stdaddproject">บันทึกข้อมูล</h5>

                            </div>
                            <form class="formmodal" method="POST" action="<?php echo e(route('addinfo')); ?>">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="modal-footer d-flex justify-content-center">
                                    <button name="id" type="button" class="btn btn-success submitmodal">ยืนยัน</button>
                ...
                <table id="table" style="overflow-x:auto;" data-toggle="table" data-height="400" data-side-pagination="client" data-pagination="true" data-page-size="All" data-query-params="searchQueryParams_invsetment" data-ajax="ajaxRequest">
                    <thead>
                        <tr class="tr_style">
                            ...
                            <th data-field="Brix" class="th-2 font-table-modal"><label class="modal-header-f justify-content-center d-flex">ค่าความหวาน</th>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <div class="input-group flex-nowrap">
                                            ...
                                            <input name="leafwidth" id="leafwidth" type="text" class="form-control ipmodal" placeholder="ซม." aria-label="Username" aria-describedby="addon-wrapping">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="input-group flex-nowrap">
                                            ...
                                            <input name="heighttree" id="heighttree" type="text" class="form-control ipmodal" placeholder="ซม." aria-label="Username" aria-describedby="addon-wrapping">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="input-group flex-nowrap">
                                            ...
                                            <input name="numberofverses" id="numberofverses" type="text" class="form-control ipmodal" placeholder="ข้อ" aria-label="Username" aria-describedby="addon-wrapping">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="input-group flex-nowrap">
                                            ...
                                            <input name="chlorophyll" id="chlorophyll" type="text" class="form-control ipmodal" placeholder="ml" aria-label="Username" aria-describedby="addon-wrapping">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="underline mt-3 mb-1"></div>
                                        ...
                                        <div class="input-group flex-nowrap">
                                            ...
                                            <input name="numberofleaf" id="numberofleaf" type="text" class="form-control ipmodal" placeholder="ใบ" aria-label="Username" aria-describedby="addon-wrapping">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="underline mt-3 mb-1"></div>
                                        ...
                                        <div class="input-group flex-nowrap">
                                            ...
                                            <input name="widthofyield" id="widthofyield" type="text" class="form-control ipmodal" placeholder="ซม." aria-label="Username" aria-describedby="addon-wrapping">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="underline mt-3 mb-1"></div>
                                        ...
                                        <div class="input-group flex-nowrap">
                                            ...
                                            <input name="Brix" id="Brix" type="text" class="form-control ipmodal" placeholder="บริกซ์." aria-label="Username" aria-describedby="addon-wrapping">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="underline mt-3 mb-1"></div>
                                        ...
                                        <div class="input-group flex-nowrap">
                                            ...
                                            <input name="weight" id="weight" type="text" class="form-control ipmodal" placeholder="กก." aria-label="Username" aria-describedby="addon-wrapping">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer d-flex justify-content-center">
                                <button name="id" type="submit" class="btn btn-success btnedit">ยืนยัน</button>
                                <button type="cancle" class="btn btn-danger" data-bs-dismiss="modal">ยกเลิก</button>
...
<?php echo $__env->make('layouts.student', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/MelonNew/resources/views/student/stdaddinfo.blade.php ENDPATH**/ ?>