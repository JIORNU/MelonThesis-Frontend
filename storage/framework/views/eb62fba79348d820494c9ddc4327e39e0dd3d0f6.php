...
<script>
    ...
    function chart1() {
        var data = $('.test').val()
        var species = <?php echo json_encode($speciesarr, 15, 512) ?>;
...
<?php echo $__env->make('layouts.teacher', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/MelonNew/resources/views/teacher/teachergraph.blade.php ENDPATH**/ ?>