...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', ".mbsc-schedule-event", function() {
            ...
            for(var i=0;i<calender.length;i++){
                if(calender[i]['id'] == id){
                    $('#stdname').val(calender[i]['studentname'])
                    break
                }
    ...
    function createAddPopup(elm) {
        ...
        popup.setOptions({
            ...
            },'', { // More info about buttons: https://docs.mobiscroll.com/5-14-1/javascript/eventcalendar#opt-buttons
                text: 'Add',
                keyCode: 'enter',
                cssClass: 'mbsc-popup-button-primary btnck '
            },
    ...
    function createEditPopup(args) {
        ...
        popup.setOptions({
            ...
            buttons: ['cancel', { // More info about buttons: https://docs.mobiscroll.com/5-14-1/javascript/eventcalendar#opt-buttons
                ...
                cssClass: 'mbsc-popup-button-primary btnsave'
            }]
        });
...
<?php echo $__env->make('layouts.teacher', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/MelonNew/resources/views/events/teachercalendar.blade.php ENDPATH**/ ?>