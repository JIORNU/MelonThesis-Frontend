...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card" style="background: linear-gradient(135deg, #EC720E 0%, #FA0F59 100%);box-shadow:2px 2px 5px rgb(0 0 0 / 40%); ">
                        <div class="card-header"><?php echo e(__('เปลี่ยนรหัสผ่าน')); ?></div>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group row">
                                    <label for="password" class="col-md-4 col-form-label text-md-right"><?php echo e(__('รหัสผ่าน')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group row">
                                    <label for="password-confirm" class="col-md-4 col-form-label text-md-right"><?php echo e(__('ยืนยันรหัสผ่าน')); ?></label>
...
</html><?php /**PATH /var/www/MelonNew/resources/views/auth/passwords/reset.blade.php ENDPATH**/ ?>